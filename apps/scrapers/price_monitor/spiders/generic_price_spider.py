...
class GenericPriceSpider(scrapy.Spider):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # EPA C4 (READY-005): the C3 grant this crawl was authorized
        # under. See the browser spider's identical field for why a
        # missing grant still records the operation rather than
        # suppressing it.
